...
[![Stars](https://img.shields.io/github/stars/MayurJivani/Mysic?style=flat-square)](https://github.com/MayurJivani/Mysic/stargazers)
...
Each half has its own `package.json`; install and run them separately.
